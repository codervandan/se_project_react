...
function ToggleSwitch() {
    // TODO - desctructure the handleTempUnitChange
    const contextValue = useContext(CurrentTemperatureUnitContext);

    return (
    <label htmlFor= "toggle-switch" className="toggle-switch">
        <input id="toggle-switch" type="checkbox" className="toggle-switch__checkbox"  onChange={contextValue.handleTempUnitChange}/>
